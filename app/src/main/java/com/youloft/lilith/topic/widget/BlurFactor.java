...
public class BlurFactor {
    ...
    public  Bitmap of(Context context, Bitmap source, BlurFactor factor) {
    ...
    public  boolean hasZero(int... args) {
        for (int num : args) {
            if (num == 0) {
                return true;
            }
    ...
    public  Bitmap stack(Bitmap sentBitmap, int radius, boolean canReuseInBitmap) {
    ...
    public  Bitmap rs(Context context, Bitmap bitmap, int radius) throws RSRuntimeException {
